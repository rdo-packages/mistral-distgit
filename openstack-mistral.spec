...
%global pydefault_oslo_config_gen python3-oslo-config-generator
%else
%global pydefault 2
%global pydefault_oslo_config_gen oslo-config-generator
%endif
...
%{?python_provide:%python_provide python%{pydefault}-mistral-tests}
Requires:       %{name}-common = %{version}-%{release}
