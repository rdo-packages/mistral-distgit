...
Requires:       python-ironicclient >= 1.6.0
...
%changelog
* Tue Oct 18 2016 Haikel Guemar <hguemar@fedoraproject.org> 3.0.2-1
- Update to 3.0.2
...
* Thu Sep 29 2016 Alfredo Moralejo <amoralej@redhat.com> 3.0.0-0.3.0rc2
